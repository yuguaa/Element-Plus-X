...
Control file loading states (uploading, done, error) and progress display.
</docs>
...
<template>
  <div style="display: flex; flex-direction: column; gap: 12px">
    <div class="files-card-container-wrapper">
      <span
        >Set status property to control file loading state: "uploading", "done",
        "error"</span
      >
      ...
      <span
        >"uploading"+"percent" controls upload progress, "error"+"errorTip"
        controls custom error message
      </span>
      <div class="files-card-container">
        <FilesCard
        ...
        <FilesCard
          ...
          status="error"
          error-tip="Custom error message"
        />
      </div>
    </div>
  </div>
