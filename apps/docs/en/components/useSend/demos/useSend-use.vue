...
const { send, abort, loading } = useSend({
  sendHandler: startFn,
  abortHandler: () => {
    ElMessage.info('Custom voice button, end recording!');
  }
});
...
const {
  ...
  sendHandler: startFn,
  abortHandler: () => {
    ElMessage.info('Custom send button, end sending!');
  }
});
...
const {
  ...
  sendHandler: startFn,
  abortHandler: () => {
    ElMessage.info('Custom play button, end playing!');
  }
});
...
const {
  ...
  sendHandler: startFn,
  abortHandler: () => {
    ElMessage.info('Custom record button, end recording!');
  }
});
